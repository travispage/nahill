...
<?php if ( ! wpgrade::option('nav_show_always') ) : ?>
	...
	<a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="cart-widget-label"><?php _e( 'Cart', wpgrade::textdomain() ); ?></a>
...
<span class="cart-items-number"><?php echo sprintf( _n( '%d', WC()->cart->get_cart_contents_count(), wpgrade::textdomain() ), WC()->cart->get_cart_contents_count() ); ?></span>
<div class="cart-widget-details">
	<?php if ( ! WC()->cart->is_empty() ) : ?>

		<p class="cart-widget-summary">
			<?php echo __( 'You have ', wpgrade::textdomain() ) . '<cart class="shop-items-number">' . WC()->cart->get_cart_contents_count() . __(' items in cart.', wpgrade::textdomain() ); ?>
		</p>
